                    ...
                    {showIns && (
                      <div className="instructions">
                        ...
                        <div className="insdesc mb-5">
                          ...
                          <br />
                          <p>
                            Welcome to the Speed Math game! In this game, you
                            will have 3 minutes to solve as many math problems
                            as possible using mental calculations. To start the
                            game, simply click on the "Start Game" button on
                            the screen.
                          </p>
                          <br />
                          <p>
                            <span>&#x25cf;</span> Once you click on the start
                            button, there will be a countdown from 3, 2, 1, and
                            then the timer will begin.
                          </p>
                          <p>
                            <span>&#x25cf;</span> You will be presented with a
                            series of math problems, one at a time, and you
                            must solve each problem as quickly as possible.
                          </p>
                          <p>
                            <span>&#x25cf;</span> To answer a question, simply
                            type your answer in the input box provided on the
                            screen and hit "enter" or "submit". If your answer
                            is correct, you will receive one point, and if it
                            is incorrect, you will receive zero points.
                          </p>
                          <p>
                            <span>&#x25cf;</span> Keep in mind that the game
                            is timed, so the faster you can solve the problems,
                            the more points you will be able to earn.
                          </p>
                          <p>
                            <span>&#x25cf;</span> At the end of the 3-minute
                            countdown, the game will automatically stop, and
